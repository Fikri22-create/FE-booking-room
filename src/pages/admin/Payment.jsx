...
export default function Payments() {
    ...
    const getStatusBadge = (status) => {
        switch (status) {
            case "paid":
                return (
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-bold uppercase tracking-wider bg-emerald-100 text-emerald-700">Paid</span>
                );
            case "refunded":
                return (
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-bold uppercase tracking-wider bg-rose-100 text-rose-700">Ref</span>
                );
            default:
                return (
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-bold uppercase tracking-wider bg-amber-100 text-amber-700">Pen</span>
                );
        }
    };
    return (
