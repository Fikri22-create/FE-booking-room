...
export default function MyPayments() {
    ...
    const getStatusBadge = (
        ...
        switch (status) {
            ...
            case "refunded":
                return (
                    <span className="px-3 py-1 rounded-lg text-xs font-semibold bg-rose-100 text-rose-700">
                        Refunded
                    </span>
                );
            ...
            default:
                return (
                    <span className="px-3 py-1 rounded-lg text-xs font-semibold bg-amber-100 text-amber-700">
                        Pending
                    </span>
                );
        }
        ...
        <div className="space-y-6">
            ...
            {selectedProof && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
                    ...
                    <div className="bg-white p-4 rounded-2xl max-w-3xl">
